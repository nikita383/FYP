function [w, risk, ret, sharpe] = robust_box_poly(n, m,p,f,asset_ret,omega,alpha, Gamma)
...
[(1+nu) nu 1 (inv_tau_nu + tau); nu (1+nu) 0 0; 1 0 (1+nu) 0; (inv_tau_nu + tau) 0 0 (1+nu)]>=0; %% doesnt work outside the seed
