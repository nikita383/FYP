...
for i=1:sz_omega
    ...
    [w3,risk3,ret3,sharpe3]= robust2(n, m,p,f,asset_ret,alpha,omega_vec(i));
    ...
    for j = 1:size(Gamma_vec,2)
        ...
        % robust optimisation
        [w2,risk2,ret2,sharpe2]= robust_box_poly_rl_4(n, m,p,f,asset_ret,omega_vec(i),alpha, Gamma_vec(j));
